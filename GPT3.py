...
train_texts, val_texts, train_labels, val_labels = train_test_split(
    training_set["text"], training_set["label"], random_state=42
)

tokenizer = GPT2Tokenizer.from_pretrained("gpt2-xl")
model = GPT2ForSequenceClassification.from_pretrained(
    "gpt2-xl", num_labels=2, n_head=32, ignore_mismatched_sizes=True
)
...
def evaluate_test_set():
    ...
    print(
        f"Test loss: {test_loss:.3f}, Test accuracy: {test_acc / len(test_dataset):.3f}"
    )
